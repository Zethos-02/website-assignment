...
<!DOCTYPE html>
    <html lang="en">
        <head>
            <title>Invoice Form Delete</title>
            <meta charset="UTF-8">
        ...
        <body>
            ...
            <div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>
                ...
                <div class="w3-main" style="margin-left:250px">
                    ...
                    <h1 class="w3-text-teal">Delete</h1>
                    <p>This section is used to delete either a specific row from the database or to delete the whole database.</p>
                </div>
            </div>

            <!-- Table with delete column + button -->
            <div class="w3-row">
                <div class="w3-twothird w3-container">
                    <h1 class="w3-text-teal">Table</h1>
                    ...
                    <table cellspacing="0" cellpadding="1" border="1" width=auto>
                        ...
                        <tbody>
                            <?php
                                 ...
                                 {
                                    echo "<tr><form action='delete.php' method=post>"; //calls the delete.php script when button is pressed
                    ...
                    <!-- Delete all records -->
                    <p><a href='deleteAll.php'>Delete all invoices!</a></p> 
                </div>
            </div>
